  ...
  function Navbar({ onMenuClick, activeApp, setActiveApp }) {
    ...
    // NEW: State for mobile application menu
    ...
    // MODIFIED: Handle menu click differently for mobile and desktop
    const handleMenuOpen = (event) => {
      if (isMobile) {
        // On mobile, open the application menu
        setAppMenuAnchor(event.currentTarget);
        setAppMenuOpen(true);
      } else {
        // On desktop, open the user menu
    ...
    // NEW: Handle application menu close
    const handleAppMenuClose = () => {
      setAppMenuAnchor(null);
      setAppMenuOpen(false);
    };
    
    // NEW: Handle application selection from mobile menu
        ...
        <nav className="navbar">
          <div className="navbar-container">
            ...
            <div className="navbar-menu">
              ...
              {/* NEW: APPLICATIONS MENU FOR MOBILE */}
              {isMobile && (
                <Menu
