...
export const getTemperatureLogs = async (slaveId, startDatetime, endDatetime, limit = 30, offset = 0) => {
  try {
    ...
    console.log(`Making temperature logs API call for slave ${slaveId} with token:`, token.substring(0, 20) + '...');
...
export const getTemperatureSlaves = async () => {
  try {
    ...
    console.log('Making temperature slaves API call with token:', token.substring(0, 20) + '...');
    console.log('API Base URL:', apiClient.defaults.baseURL);
